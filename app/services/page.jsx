...
import { ArrowRight, ShieldCheck, Zap, PenTool, Globe, ChevronDown } from "lucide-react";
...
const services = [
    ...
    {
        title: "Sign Boards",
        desc: "3D Acrylic, neon, and high-impact signage. Create a bold brand presence with our custom commercial signage solutions.",
        img: "/sign.jpg",
        ...
        <main className="w-full h-full bg-[#F9F9F7] text-[#1A1A1A] selection:bg-[#CCAC34] selection:text-white">
            ...
            <section className="relative w-full h-[85vh] md:h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <Image src="/crafting.jpg" fill alt="Joinery Dubai" className="object-cover" priority />
                    <div className="absolute inset-0 bg-black/60" />
                </div>
                <div className="relative z-20 text-center px-6 max-w-4xl">
                    <FadeIn direction="up">
                        <span className="text-[#CCAC34] tracking-[0.6em] text-[10px] uppercase font-bold mb-6 block">Premium Craftsmanship</span>
            ...
            <section className="py-10 bg-[#1A1A1A] border-y border-white/5">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-wrap justify-between items-center gap-8 opacity-90 transition-all">
                        {['Palm Jumeirah', 'Emirates Hills', 'Dubai Mall', 'Business Bay', 'Downtown Dubai'].map((loc) => (
                            <span key={loc} className="text-white font-black text-[10px] uppercase tracking-[0.3em] italic">{loc}</span>
                        ))}
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                        ...
                        <div className="relative z-10">
                            <FadeIn direction="left">
                                <span className="text-[#CCAC34] font-bold tracking-[0.4em] text-[10px] uppercase mb-4 block">Unmatched Standards</span>
                                <h2 className="text-4xl md:text-6xl font-black italic uppercase tracking-tighter leading-[0.9] mb-10">
                                    Why Architects <br /> Trust Our <span className="text-[#CCAC34]">Work.</span>
                                </h2>

                                <div className="space-y-6 text-gray-600 leading-relaxed max-w-xl">
                                    <p className="text-lg font-medium text-[#1A1A1A]">
                                        At The Dubai Carpenter, we don't just build furniture; we engineer architectural elements that define the soul of a space.
                                    </p>
                                    <p>
                                        With over a decade of deep-rooted experience in the <strong>UAE’s luxury fit-out sector</strong>, we’ve mastered the art of balancing aesthetic ambition with structural integrity. Our joinery workshop in Dubai is equipped with high-precision machinery, but it’s our master craftsmen who ensure every joint is seamless.
                                    </p>
                                    <p>
                                        We specialize in working with premium materials—from <strong>exotic veneers</strong> and <strong>solid hardwoods</strong> to integrated <strong>smart lighting systems</strong>. This multi-disciplinary approach is why leading interior designers and consultants choose us for their most challenging residential and commercial projects.
                                    </p>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-8 mt-12 pt-10 border-t border-gray-100">
                                    <div>
                                        <span className="text-3xl font-black italic text-[#1A1A1A] block">500+</span>
                                        <span className="text-[10px] uppercase tracking-widest font-bold text-[#CCAC34]">Projects Delivered</span>
                                    </div>
                                    <div>
                                        <span className="text-3xl font-black italic text-[#1A1A1A] block">100%</span>
                                        <span className="text-[10px] uppercase tracking-widest font-bold text-[#CCAC34]">Bespoke Designs</span>
                                    </div>
                                </div>
                            </FadeIn>
                        </div>
                            ...
                            <FadeIn direction="right">
                                <div className="relative aspect-square md:aspect-[4/5] rounded-[3rem] md:rounded-[5rem] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] group">
                                    ...
                                    <div className="absolute w-44 bottom-8 left-8 bg-[#CCAC34] p-8 rounded-[2.5rem] shadow-2xl z-20 transform -rotate-3 hover:rotate-0 transition-transform duration-500">
                                        <span className="text-5xl font-black italic text-white block leading-none">10+</span>
                                        <span className="text-white text-[10px] uppercase tracking-widest font-bold mt-2 block">Years of <br /> UAE Excellence</span>
                                    </div>
            ...
            <section className="py-24 bg-[#F9F9F7]">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="mb-16">
                        <FadeIn direction="up">
                            <span className="text-[#CCAC34] text-center font-bold tracking-[0.4em] text-[10px] uppercase mb-4 block">The Bizgrow Standard</span>
                            <h2 className="text-5xl text-center md:text-6xl font-black italic uppercase tracking-tighter leading-none">
                                Committed to <br /> <span className="text-[#CCAC34]">Superior Quality.</span>
                            </h2>
                        </FadeIn>
                    </div>
                    ...
                    <div className="grid grid-cols-1  md:grid-cols-3 gap-8">
                        {[
                            {
                                icon: <ShieldCheck className="text-[#CCAC34] " size={32} strokeWidth={1.5} />,
                                t: "2-Year Warranty",
                                d: "Every installation is backed by a full structural warranty for long-term peace of mind."
                            },
                            {
                                icon: <Zap className="text-[#CCAC34]" size={32} strokeWidth={1.5} />,
                                t: "German Hardware",
                                d: "We exclusively use Blum and Hettich fittings for lifelong smooth and silent operation."
                            },
                            {
                                icon: <PenTool className="text-[#CCAC34]" size={32} strokeWidth={1.5} />,
                                t: "Custom 3D Renders",
                                d: "Visualize your space with precision 3D modeling before we cut the first piece of wood."
                            }
                        ].map((item, i) => (
                            <div key={i} className="group p-12  bg-white rounded-[2.5rem] border border-black/5 hover:border-[#CCAC34]/30 transition-all duration-500 hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)]">
                                ...
                                <h4 className="text-xl font-black uppercase italic mb-4 tracking-tighter">{item.t}</h4>
            ...
            <section className="py-32 bg-white">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        <FadeIn direction="up">
                            <span className="text-[#CCAC34] font-bold tracking-[0.6em] text-[10px] uppercase mb-4 block">Our Expertise</span>
                            ...
                            <p className="text-gray-500 text-sm md:text-base leading-relaxed">
                                From residential sanctuaries to high-impact commercial environments,
                                we deliver precision-engineered joinery and fit-out services.
                            </p>
                        </FadeIn>
                    </div>
                                    ...
                                    <div className="relative z-30 h-full p-12 flex flex-col justify-end">
                                        ...
                                        <div className="absolute top-12 right-12">
                                            <div className="relative flex items-center justify-center w-20 h-20 rounded-full border border-white/5 bg-white/5 backdrop-blur-2xl transition-all duration-500 group-hover:border-[#CCAC34]/40 group-hover:bg-[#CCAC34]/10">
                                                ...
                                                <span className="relative z-10 text-[#CCAC34] font-black italic text-sm">0{i + 1}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-8 pt-8 border-t border-white/5 flex items-center justify-between opacity-0 group-hover:opacity-100 transition-all duration-700 translate-y-10 group-hover:translate-y-0">
                                            <button className="flex items-center gap-4 text-white font-black text-[9px] uppercase tracking-[0.4em] group/btn">
                                                <span className="group-hover/btn:text-[#CCAC34] transition-colors">Request Catalog</span>
            ...
            <section className="py-24 bg-black text-white">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                        {[
                            { step: "01", t: "Consultation", d: "Site visit & technical measurement." },
                            { step: "02", t: "3D Modeling", d: "Visualizing the joinery design." },
                            { step: "03", t: "Production", d: "Crafting in our Dubai workshop." },
                            { step: "04", t: "Installation", d: "Final fitting with 2-year warranty." }
                        ].map((item, i) => (
                            <div key={i} className="border-l border-[#CCAC34]/30 pl-8">
                                <span className="text-4xl font-black italic text-[#CCAC34] block mb-4">{item.step}</span>
                                <h4 className="text-xl font-bold uppercase tracking-tighter mb-2">{item.t}</h4>
            ...
            <section className="py-24 px-6 relative">
                <div className="max-w-7xl mx-auto">
                    <div className="relative overflow-hidden rounded-[4rem] bg-[#0A0A0A]/40 border border-white/10 shadow-2xl p-12 md:p-32 text-center group">
                        <div className="absolute inset-0 z-0 bg-no-repeat bg-cover bg-center" style={{ backgroundImage: "url('/services-cta.jpg')", backgroundAttachment: 'fixed' }} />
                            ...
                            <div className="flex flex-col md:flex-row justify-center gap-6 items-center">
                                ...
                                className="bg-white relative overflow-hidden group/btn  text-black px-12 py-6 rounded-2xl
                                 font-black uppercase tracking-[0.2em] text-xs
                                    transition-all">
                                   <span className="relative z-10 group-hover/btn:text-white">Download Brochure</span> 
                                ...
                                <button className="text-[#CCAC34] font-bold uppercase tracking-[0.2em] text-[10px] flex items-center gap-2">WhatsApp Inquiries <span>→</span></button>
                            </div>
                        </div>
                    </div>
                </div>
