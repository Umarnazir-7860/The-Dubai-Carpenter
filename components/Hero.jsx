      ...
      <div className="relative z-20 h-full flex flex-col justify-center px-6 md:px-24">
        ...
        >
          <a
            ...
            className="inline-block w-full sm:w-auto relative group overflow-hidden border border-[#CCAC34] text-white px-8 md:px-12 py-4 md:py-5 font-black rounded-full text-[10px] tracking-[0.3em] uppercase transition-all text-center"
          >
